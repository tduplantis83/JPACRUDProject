...
<body>
	<div class="container">
		<div class="row">
			<div class="col-2"></div>
			<div class="col-8">
				<h2 style="color: red">Delete this Charging Station</h2>
				<c:choose>
					<c:when test="${deleteStatus}">
						<h2 style="color: red">Charging Station Deletion Failed!</h2>
					</c:when>
				</c:choose>
				<div class="col-2"></div>
			</div>
